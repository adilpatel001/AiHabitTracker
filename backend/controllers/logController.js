...
export const getHabitStats = async (req, res) => {
  try {
    ...
    // Calculate completion rate since the habit was originally created
    ...
    // Monthly completion breakdown for the trailing 6 months
    const monthly = {};
    for (const l of logs) {
      const m = l.completedDate.slice(0, 7); // Captures YYYY-MM
